...
//TODO add null checks for each call
...
public class SmartShipApplication {
    ...
    public static void main(String[] args) {
        try {
            ...
            final Map<String, String> customerNameToFileName;
            //map of customer File names to Workbooks
            final Map<String, Workbook> mapCustomerFileNameWb;
            ...
            final CellAddress cellCustomerName = UtilityMethods.findCellByName(sheet, Constants.CUSTOMER_COLUMN_NAME);
            ...
            //populate map of customer names to file names
            customerNameToFileName = UtilityMethods.populateCustomerAndFileNames(invoiceWb);

            //create customer workbooks, file per customer name
            mapCustomerFileNameWb = UtilityMethods.createCustomerWbMap(row, customerNameToFileName);
